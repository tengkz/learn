...
def main(num_epochs=NUM_EPOCHS):
    ...
    # lstm output
    lstm_output = lasagne.layers.get_output(l_forward_2)
    ...
    lstm_ret = theano.function([l_in.input_var],lstm_output,allow_input_downcast=True)
